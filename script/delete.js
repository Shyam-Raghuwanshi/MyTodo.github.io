...
if (Object.keys(deletedTodos).length ==0  ? nullOrNot.innerHTML += `<span  class="text-[2rem]  font-bold">Deleted :- No Todos</span>` : nullOrNot.innerHTML += `<span  class="text-[2rem]  font-bold">Deleted Todos </span>`)
